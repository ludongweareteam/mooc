...
(function(exports){
    ...
    var swfid,swfobject,onActionlist = {},config = {"width":"100%","height":"100%","id":"cloudsdk","wmode":"transparent"};
    ...
    var eventlist = {"ERROR":[],"START":[],"LOADING":[],"PLAY":[],"TIMEING":[],"PAUSE":[],"STOP":[]},playconfig = {"vk":"","tk":"","tltime":0,"auto":1,"fmatid":0};
    var pwidth,pheight;
