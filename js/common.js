                ...
                '<section class="dis e-login-ele">'+
                    ...
                    '<div>'+
                        '<ol class="e-login-options">'+
                            '<li>'+
                                '<input id="u-email" type="text" placeholder="请输入登录邮箱/手机"  name="" value="" onkeyup="$(this).next().html(\'\');">'+
                        ...
                        '<span class="fl"><label class="hand c-999 vam"><input type="checkbox" style="vertical-align: -2px;" checked="checked" id="autoThirty">自动登录</label><a class="vam ml10 c-blue" title="" href="/front/passwordRecovery">忘记密码?</a></span></section>'+
